...
export default function NotificationsClient({ initialNotifs }: { initialNotifs: any[] }) {
  ...
  return (
    <>
      <Topbar
        ...
        action={unreadCount > 0 ? { label: 'Mark all read', onClick: markAllRead } : undefined}
      />
            ...
            >
              ...
              >
                <div style={{ display:'flex', gap:12, alignItems:'flex-start' }}>
                  <span style={{ fontSize:'.65rem', fontWeight:700, letterSpacing:'.06em', padding:'2px 6px', background:'rgba(242,100,25,0.12)', color:'#F26419', flexShrink:0 }}>
                    {ICONS[n.type] ?? 'NOTE'}
                  </span>
                  <div style={{ flex:1 }}>
